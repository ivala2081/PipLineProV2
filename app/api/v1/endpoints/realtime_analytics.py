...
api_logger = get_structured_logger('app.api.realtime_analytics')
...
def get_realtime_metrics():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/metrics", "GET", current_user.id)
        
        analytics_service = get_real_time_analytics()
        metrics = analytics_service.get_real_time_metrics()
        
        api_logger.log_api_request("/realtime_analytics/metrics", "GET", current_user.id, 200)
        return jsonify(metrics), 200
        
    except Exception as e:
        logger.error(f"Error getting real-time metrics: {str(e)}")
        api_logger.log_api_request("/realtime_analytics/metrics", "GET", current_user.id, 500)
        return jsonify({
...
def get_realtime_dashboard():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/dashboard", "GET", current_user.id)
        ...
        api_logger.log_api_request("/realtime_analytics/dashboard", "GET", current_user.id, 200)
        return jsonify(dashboard_data), 200
        
    except Exception as e:
        logger.error(f"Error getting real-time dashboard: {str(e)}")
        api_logger.log_api_request("/realtime_analytics/dashboard", "GET", current_user.id, 500)
        return jsonify({
...
def get_psp_performance(psp_name):
    ...
    try:
        api_logger.log_api_request(f"/realtime_analytics/psp/{psp_name}/performance", "GET", current_user.id)
        
        analytics_service = get_real_time_analytics()
        performance_data = analytics_service.get_psp_performance_stream(psp_name)
        
        api_logger.log_api_request(f"/realtime_analytics/psp/{psp_name}/performance", "GET", current_user.id, 200)
        return jsonify({
            'psp_name': psp_name,
        ...
        api_logger.log_api_request(f"/realtime_analytics/psp/{psp_name}/performance", "GET", current_user.id, 500)
        return jsonify({
...
def get_revenue_stream():
    ...
    try:
        ...
        api_logger.log_api_request(f"/realtime_analytics/revenue/stream?hours={hours}", "GET", current_user.id)
        
        analytics_service = get_real_time_analytics()
        revenue_data = analytics_service.get_revenue_stream(hours)
        
        api_logger.log_api_request(f"/realtime_analytics/revenue/stream?hours={hours}", "GET", current_user.id, 200)
        return jsonify({
            'hours': hours,
        ...
        api_logger.log_api_request("/realtime_analytics/revenue/stream", "GET", current_user.id, 500)
        return jsonify({
...
def get_active_alerts():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/alerts", "GET", current_user.id)
        ...
        api_logger.log_api_request("/realtime_analytics/alerts", "GET", current_user.id, 200)
        return jsonify({
            'alerts': alerts,
            'count': len(alerts),
        ...
        api_logger.log_api_request("/realtime_analytics/alerts", "GET", current_user.id, 500)
        return jsonify({
...
def get_trends():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/trends", "GET", current_user.id)
        
        analytics_service = get_real_time_analytics()
        metrics = analytics_service.get_real_time_metrics()
        trends = metrics.get('trends', {})
        
        api_logger.log_api_request("/realtime_analytics/trends", "GET", current_user.id, 200)
        return jsonify(trends), 200
        
    except Exception as e:
        logger.error(f"Error getting trends: {str(e)}")
        api_logger.log_api_request("/realtime_analytics/trends", "GET", current_user.id, 500)
        return jsonify({
...
def get_performance_metrics():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/performance", "GET", current_user.id)
        
        analytics_service = get_real_time_analytics()
        metrics = analytics_service.get_real_time_metrics()
        performance = metrics.get('performance', {})
        
        api_logger.log_api_request("/realtime_analytics/performance", "GET", current_user.id, 200)
        return jsonify(performance), 200
        
    except Exception as e:
        logger.error(f"Error getting performance metrics: {str(e)}")
        api_logger.log_api_request("/realtime_analytics/performance", "GET", current_user.id, 500)
        return jsonify({
...
def get_service_status():
    ...
    try:
        api_logger.log_api_request("/realtime_analytics/status", "GET", current_user.id)
        ...
        api_logger.log_api_request("/realtime_analytics/status", "GET", current_user.id, status_code)
        return jsonify(status_data), status_code
        
    except Exception as e:
        logger.error(f"Error getting service status: {str(e)}")
        api_logger.log_api_request("/realtime_analytics/status", "GET", current_user.id, 500)
        return jsonify({
            'service': 'real_time_analytics',
            'status': 'error',
            'error': str(e),
