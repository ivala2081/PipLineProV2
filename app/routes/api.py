...
from app.utils.logger import get_logger, performance_log, DatabaseLogger
...
@login_required
@handle_api_errors
@performance_log("get_transaction_details")
...
@login_required
@handle_api_errors
@performance_log("psp_summary_stats")
...
@login_required
@handle_api_errors
@performance_log("dashboard_stats")
...
@login_required
@handle_api_errors
@performance_log("transactions_list")
def api_transactions_list():
    ...
    try:
        ...
        if client_name:
            query = query.filter(Transaction.client_name.ilike(f'%{client_name}%'))
...
@login_required
@handle_api_errors
@performance_log("analytics_overview")
