-- ============================================================================
-- 051: get_psp_ledger — server-side daily ledger grouping per PSP
-- Moves the join/grouping logic to SQL (SECURITY DEFINER) so it uses the
-- same approach as get_psp_summary — bypassing any PostgREST join issues.
-- ============================================================================
