-- ============================================================================
-- 101: Extend page-level permissions to cover ALL sidebar pages
--
-- Previously only page:dashboard, page:members, page:ai were in the system.
-- Now we add: page:transfers, page:accounting, page:psps, page:hr,
--             page:organizations, page:security, page:audit
--
-- Defaults match the hardcoded roles arrays that were in nav-config.ts.
-- ============================================================================
...
-- ============================================================================
-- 2. Update get_role_permissions_with_defaults to include new page entries
-- ============================================================================
...
-- ============================================================================
-- 3. Update get_my_page_permissions to include new page entries
-- ============================================================================
