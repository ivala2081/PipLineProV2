...
export const basicInputClasses =
  'peer text-black bg-bg2/75 inset-ring inset-ring-black/15 placeholder:text-black/40 hover:bg-bg2/90 hover:inset-ring-black/30'

export const disabledInputClasses =
  'disabled:cursor-not-allowed disabled:bg-bg2/45 disabled:text-black/40 disabled:inset-ring-black/8'
  ...
  return (
    <div className="relative w-full">
      ...
      {title && (
        <Label
          htmlFor={id}
          className="absolute left-5 top-1 text-xs text-black/60 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs"
        >
          {title}
        </Label>
      )}
